    ...
    return Consumer<FriendProvider>(
      builder: (context, friendProvider, child) {
        ...
        if (friendProvider.friendRequests.isEmpty) {
          return const Center(
            child: Text('Tidak ada permintaan pertemanan baru.'),
          );
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final request =
                friendProvider
                    .friendRequests[index]; // Dapatkan objek permintaan
            final UserModel fromUser =
                request['fromUser']; // Dapatkan pengguna yang mengirim permintaan
            final String requestId =
                request['requestId']; // Dapatkan ID permintaan

            return Card(
              margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              elevation:
                  0, // No elevation for the card as per the latest design reference
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
              ), // Keep rounded corners for clarity
              child: ListTile(
                ...
                subtitle: const Text(
                  'Mengirimi Anda permintaan pertemanan.',
                ), // Pesan permintaan
                trailing: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            Colors
                                .lightBlue
                                .shade200, // Warna biru untuk konfirmasi
                        foregroundColor:
                        ...
                        minimumSize: const Size(
                          80,
                          36,
                        ), // Set minimum size for button as per design
                      ),
                      onPressed: () async {
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            Colors
                                .redAccent, // Grey background for delete as per design
                        foregroundColor: Colors.white, // Black text for delete
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
                        padding: const EdgeInsets.symmetric(
